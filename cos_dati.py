...
def c_dati(root):
    ...
    iestatījumi(logs, 500, 400, 'Ievada mainīgo vērtības priekš Kosīnusa viļņu funkcijas')
    ...
    vērtību_ievade = tk.Button(logs, text='Ievada vērtības',
                               command=lambda: saglabā_un_zīmē_c(amplitūds_ievades, lambda_ievades, 
...
def saglabā_un_zīmē_c(amplitūds_ievades, lambda_ievades, x_ievades):
    ...
    y = amplitūde * np.cos(k * x)  # Aprēķina kosīnusa viļņa vērtības
